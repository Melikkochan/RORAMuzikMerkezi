...
Kept here so the list is not re-proposed:

- **Backup and restore** — manual backup and restore from the menu, plus an automatic startup backup keeping the last 7 days
...
- **Per-student payment and lesson history screen** (#34) — month by month, with total collected and unpaid months highlighted
